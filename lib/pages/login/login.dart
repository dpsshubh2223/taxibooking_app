...
import 'package:app/functions/notifications.dart';
import 'package:app/pages/onTripPage/invoice.dart';
import 'package:app/pages/onTripPage/map_page.dart';
                                                          ...
                                                          RemoteNotification noti =
                                                              const RemoteNotification(
                                                                  title:
                                                                      'Otp for Login',
                                                                  body:
                                                                      'Login to your account with test OTP1 123456');
                                                          showOtpNotification(
                                                              noti);
                                                        }
                                                        // setState(() {
                                                            ...
                                                            RemoteNotification
                                                                ...
                                                                const RemoteNotification(
                                                                    title:
                                                                        'Otp for Login',
                                                                    body:
                                                                        'Login to your account with test OTP2 123456');
                                                            showOtpNotification(
                                                                noti);
                                                          } else {
                                                            Navigator.push(
                                                          ...
                                                          RemoteNotification noti =
                                                              const RemoteNotification(
                                                                  title:
                                                                      'Otp for Login',
                                                                  body:
                                                                      'Login to your account with test OTP3 123456');
                                                          showOtpNotification(
                                                              noti);
                                                        }
                                                        // setState(() {
                                                              ...
                                                              RemoteNotification
                                                                  ...
                                                                  const RemoteNotification(
                                                                      title:
                                                                          'Otp for Login',
                                                                      body:
                                                                          'Login to your account with test OTP4 123456');
                                                              showOtpNotification(
                                                                  noti);
                                                            }
                                                            // setState(() {
